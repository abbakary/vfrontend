      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
            ...
            {filtered.map((d) => {
              ...
              return (
                <DatasetCard
                  ...
                  viewType={viewType}
                  showStatus
                  onCardClick={() => setSelectedDataset(d)}
        ...
        {!loading && filtered.length === 0 && (
          <div style={{ textAlign: "center", padding: "48px 0" }}>
            <p style={{ color: "#718096", fontSize: 16, fontWeight: 600 }}>
      ...
      {selectedDataset && (
        ...
        >
          ...
          >
            ...
            >
              Review details, check history, then approve, reject, or return for
              revision.
            </p>

            <DatasetCard dataset={selectedDataset} viewType="list" showStatus />

            {/* Metadata edit (only if assigned) */}
